# ==============================================================================
# Cross-Validation Integration Test: 1D Order 2 (Local Quadratic) vs MATLAB Reference
# ==============================================================================
# Test file: fastLPR_R/tests/testthat/test-cv-1d-order2.R
...
context("Cross-validation: 1D Order 2 vs MATLAB")
...
test_that("1D Order 2 matches MATLAB reference data", {
  # Skip if MATLAB reference data not available (CRAN compatibility)
  skip_if_no_matlab_refs()

  # Find reference file path
  ref_paths <- c(
    file.path(find_root(), "fastLPR/tests/refs/crosslang_e2e/ref_1d_order2.mat"),
    "../../fastLPR/tests/refs/crosslang_e2e/ref_1d_order2.mat",
    file.path(find_root(), "fastLPR/tests/refs/crosslang_e2e/ref_1d_order2.mat")
  )
  ...
  skip_if(is.null(ref_path), "MATLAB reference file ref_1d_order2.mat not found")
  ...
  cat("\n=== 1D Order 2 Cross-Validation Test ===\n")
  ...
  # Run R implementation with MATLAB DOF random vectors
...
# ARCHIVED: 2026-01-10 - "1D Order 2 cross-validation summary" (moved to dev/archive/tests-archive-20260110/r/xl/archived_test-xl-1d-order2.R)
